...
export default function ContactPage() {
  ...
  // For Input + Textarea (event-based)
  const handleChange = (e: ChangeEvt) => {
    const { name, value } = e.target;
    setFormData((prev) => ({ ...prev, [name]: value }));
  };

  // For Select (value-based)
  const handleSelect =
              ...
              {contactInfo.map((info, index) => {
                ...
                return (
                  ...
                  >
                    <Link
                      href={info.href}
                      className="flex items-start gap-4 p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-all group"
                    >
                      <div className="w-12 h-12 bg-linear-to-br from-primary-500 to-secondary-500 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  {/* ✅ Select expects (value) => void, not event */}
                  <Select
                    label="Inquiry Type"
                    name="inquiryType"
                    value={formData.inquiryType}
                    onChange={handleSelect('inquiryType')}
