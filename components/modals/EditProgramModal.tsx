...
interface EditProgramModalProps {
  ...
  onUpdated: (program: ProgramRow) => void;
}
...
export function EditProgramModal({
  ...
  const validate = (): FormErrors => {
    ...
    if (!form.type) e.type = 'Program type is required';
    if (!form.level) e.level = 'Program level is required';
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Info banner */}
        <div className="flex gap-3 rounded-xl border border-blue-200 bg-blue-50 p-4 text-xs text-blue-800">
          ...
          <div>
            ...
            <p>
              Changes will immediately affect how this program appears in admin
              and student-facing views.
            </p>
          </div>
        </div>
