...
export function ViewStaffDetailsModal({
  ...
  // Load staff details when opened
  useEffect(() => {
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col justify-center items-center text-center gap-4">
            <div className="relative w-28 h-28 rounded-full overflow-hidden shadow-md bg-gray-100">
              <Image
                src={staff.profiles?.avatar_url || "/avatar.png"}
                fill
                alt="Staff Photo"
...
// Simple elegant label/data display
...
// Beautiful status badge focused on aesthetic consistency
